...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _racer = __webpack_require__(1);
	...
	var domLoaded = function domLoaded() {
	  var $body = $("body");
	  var racersContainer = $body.find(".racer-container");
	
	  if (racersContainer.length > 0) {
	    new _racer2.default(racersContainer);
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Racer = function () {
	  ...
	  _createClass(Racer, [{
	    ...
	    key: "selectedRacer",
	    value: function selectedRacer(event) {
	    ...
	    key: "announceWinner",
	    value: function announceWinner(player) {
	    ...
	    key: "playerOneControl",
	    value: function playerOneControl(event) {
	      if (event.keyCode == 81) {
	        this.moved1 += 20;
	    ...
	    key: "playerTwoControl",
	    value: function playerTwoControl(event) {
	      if (event.keyCode == 80) {
	        this.moved2 += 20;
